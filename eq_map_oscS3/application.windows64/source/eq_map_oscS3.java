...
public class eq_map_oscS3 extends PApplet {
...
public void mouseMoved()
{
  ...
  if(!editIP)
  {
    ...
    mouseMessage.add((int)(mouseX/3.0f)); /* add an int to the osc message */
    mouseMessage.add((int)(mouseY/3.0f)); /* add an int to the osc message */
...
public void keyPressed()
{
  ...
  public void settings() {  size(765,765); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "eq_map_oscS3" };
    if (passedArgs != null) {
